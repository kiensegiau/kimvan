...
const YouTubeNoLinkPlayer = ({ isOpen, videoId, onClose }) => {
        ...
        <body>
          <div class="player-container">
            ...
            <div class="iframe-container" id="iframe-container">
              ...
              <div class="overlay-protection endscreen-overlay"></div>
            </div>
          </div>
          ...
          <script>
            ...
            function loadYouTubeVideo() {
              ...
              youtubeIframe.src = 'https://www.youtube.com/embed/${videoId}?autoplay=1&rel=0&modestbranding=1&fs=1&color=white&iv_load_policy=3&playlist=${videoId}&controls=1&showinfo=0&disablekb=0&version=3&origin=' + window.location.origin + '&enablejsapi=1&nologo=1&cc_load_policy=0&iv_load_policy=3&referrer=no-referrer';
            ...
            function preventRedirects() {
              ...
              // Cố gắng chèn CSS vào iframe (giải pháp bổ sung, có thể không hoạt động do giới hạn CORS)
              try {
...
export default YouTubeNoLinkPlayer; 